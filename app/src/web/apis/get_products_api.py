...
async def get_products(
    ...
    return [
        ...
        Product(id='8', name='ЧЧизкейк Банановый с шоколадным печеньем ', description='Солнечный снаружи и яркий по вкусу внутри. Летняя новинка — нежныйк', categoryId='3', price='149', imageURL='https://dodopizza-a.akamaihd.net/static/Img/Products/543c6e4479c24db29427d74efde5151c_1875x1875.webp'),
